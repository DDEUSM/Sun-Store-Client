...
{    
    ...
    {        
        const searchResult = await Promise.all([
            adsAdapter.getAds( urlParams, queryString ),
            adsAdapter.getAdCountAndPg( urlParams, queryString )
        ]);
        dispatch( 
            setAds(searchResult?(
            searchResult[0]
    ...
    return(
        <>                                                                  
            <div className="flex h-full lg:w-[110%] w-full gap-2 mb-4">        
                ...
                <SearchByCategory windowStatus={windows.categorySearchWindow} type='Search'/>
